...
- Building this in public. You can follow the progress/updates on [@fullstack0330](https://github.com/fullstack0330/ECommerce-Next.Js.13)
...
```bash
git clone https://github.com/fullstack0330/ECommerce-Next.Js.13
```
